...
public class Pelimoottori extends Thread {
    ...
    /**
     * Konstruktorissa alustetaan pelimoottorin attribuutteja.
     *
     * @param ui
     * @param logiikka
     */
    ...
    /**
     * Metodi sovelluslogiikan päivittämiselle. Metodissa päivitetään myös
     * loppuvalikon viesti.
     */
    public void paivita() {
    ...
    /**
     * Apumetodi run-metodille. Metodissa määrätään, kuinka usein ohjelman
     * logiikka ja näkymä päivitetään.
     */
    public void odota() {
        try {
